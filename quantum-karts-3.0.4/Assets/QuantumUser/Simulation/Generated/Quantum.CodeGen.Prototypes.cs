...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class AIDriverPrototype : ComponentPrototype<Quantum.AIDriver> {
    ...
    public void Materialize(Frame frame, ref Quantum.AIDriver result, in PrototypeMaterializationContext context = default) {
        ...
        result.LastWeaponTime = this.LastWeaponTime;
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.KartWeapons))]
  public unsafe partial class KartWeaponsPrototype : ComponentPrototype<Quantum.KartWeapons> {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.KartWeapons result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.KartWeapons component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.KartWeapons result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]

...
namespace Quantum {
  ...
  public unsafe partial struct AIDriver : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + LastWeaponTime.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->LastWeaponTime, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct KartWeapons : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    [ExcludeFromPrototype()]
    public AssetRef<WeaponAsset> HeldWeapon;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 14107;
        hash = hash * 31 + HeldWeapon.GetHashCode();
        hash = hash * 31 + RemainingUses.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (KartWeapons*)ptr;
        serializer.Stream.Serialize(&p->RemainingUses);
        AssetRef.Serialize(&p->HeldWeapon, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Pickup : Quantum.IComponent {
    ...
    [FieldOffset(8)]
    public AssetRef<PickupAsset> Asset;
    [FieldOffset(0)]
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.KartWeapons>();
      BuildSignalsArrayOnComponentRemoved<Quantum.KartWeapons>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.KartWeapons), Quantum.KartWeapons.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 17)
        ...
        .Add<Quantum.KartWeapons>(Quantum.KartWeapons.Serialize, null, null, ComponentFlags.None)

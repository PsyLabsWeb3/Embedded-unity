...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventWeaponCollected.ID: result = typeof(EventWeaponCollected); return;
          case EventWeaponUsed.ID: result = typeof(EventWeaponUsed); return;
          case EventOnPickupCollected.ID: result = typeof(EventOnPickupCollected); return;
          case EventOnPickupRespawn.ID: result = typeof(EventOnPickupRespawn); return;
      ...
      public EventWeaponCollected WeaponCollected(EntityRef kartEntity, KartWeapons kartWeapons) {
        var ev = _f.Context.AcquireEvent<EventWeaponCollected>(EventWeaponCollected.ID);
        ev.kartEntity = kartEntity;
        ev.kartWeapons = kartWeapons;
        _f.AddEvent(ev);
        return ev;
      }
      public EventWeaponUsed WeaponUsed(EntityRef kartEntity, KartWeapons kartWeapons) {
        var ev = _f.Context.AcquireEvent<EventWeaponUsed>(EventWeaponUsed.ID);
        ev.kartEntity = kartEntity;
        ev.kartWeapons = kartWeapons;
        _f.AddEvent(ev);
        return ev;
      }
      public EventOnPickupCollected OnPickupCollected(EntityRef PickupEntity) {
        var ev = _f.Context.AcquireEvent<EventOnPickupCollected>(EventOnPickupCollected.ID);
        ev.PickupEntity = PickupEntity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventOnPickupRespawn OnPickupRespawn(EntityRef PickupEntity) {
        var ev = _f.Context.AcquireEvent<EventOnPickupRespawn>(EventOnPickupRespawn.ID);
        ev.PickupEntity = PickupEntity;
        _f.AddEvent(ev);
        return ev;
      }
  ...
  public unsafe partial class EventWeaponCollected : EventBase {
    public new const Int32 ID = 9;
    public EntityRef kartEntity;
    public KartWeapons kartWeapons;
    protected EventWeaponCollected(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventWeaponCollected() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 73;
        hash = hash * 31 + kartEntity.GetHashCode();
        hash = hash * 31 + kartWeapons.GetHashCode();
        return hash;
      }
    }
  }
  public unsafe partial class EventWeaponUsed : EventBase {
    public new const Int32 ID = 10;
    public EntityRef kartEntity;
    public KartWeapons kartWeapons;
    protected EventWeaponUsed(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventWeaponUsed() : 
  ...
  public unsafe partial class EventOnPickupCollected : EventBase {
    public new const Int32 ID = 11;
    public EntityRef PickupEntity;
    protected EventOnPickupCollected(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnPickupCollected() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 83;
        hash = hash * 31 + PickupEntity.GetHashCode();
        return hash;
      }
    }
  }
  public unsafe partial class EventOnPickupRespawn : EventBase {
    public new const Int32 ID = 12;
    public EntityRef PickupEntity;
    protected EventOnPickupRespawn(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnPickupRespawn() : 
